...
create or replace transient table NL2SQL_ANALYTICS.MARTS.mart_accuracy_by_difficulty
    ...
    as (-- Execution accuracy per BIRD-SQL difficulty band, split by run configuration.
